        ...
        <div class="row ">
          ...
          <div class="col-sm-6 col-md-3 col-xs-12 block">
            <div class="thumbnail thumbnailContent wow fadeInUp">
              <a href="{{ route('home.course.detail',['id'=>fencrypt($item->id), 'name'=>Illuminate\Support\Str::slug($item->full_name)])}}"><img src="{{ asset(getImage($item->image)) }}" alt="{{$item->full_name}}" class="img-responsive"></a>
              <div class="caption border-color-1">
                <h3><a href="{{ route('home.course.detail',['id'=>fencrypt($item->id), 'name'=>Illuminate\Support\Str::slug($item->full_name)])}}" class="color-1">{{$item->full_name}}</a></h3>
                ...
                <ul class="list-inline btn-yellow">
                  ...
                  <li><a href="{{ route('home.course.detail',['id'=>fencrypt($item->id), 'name'=>Illuminate\Support\Str::slug($item->full_name)])}}" class="btn btn-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i> Chi tiết</a></li>
                </ul>
              </div>
            </div>
          </div>
