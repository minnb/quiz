@extends('admin.app')
@section('title', 'Chỉnh sửa thông tin Giáo viên')
@section('stylesheet')
...
<div class="container-fluid card">
	<br>
	<form name="create-question" action="{{ route('post.admin.teacher.edit', ['id'=>fencrypt($teacher_id)])}}" method="POST" enctype="multipart/form-data">
		...
		<div class="row backgroud_white">
			<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
				...
				<div class="form-group">
					...
					<input type="email" name="email" class="form-control" required="" value="{{ old('email', isset($data) ? $data['email'] : '')}}"/>
				</div>
				<div class="form-group">
					<label>Số điện thoại</label>
					<input type="text" name="phone" class="form-control" value="{{ old('phone', isset($data) ? $data['phone'] : '')}}"/>
				</div>
				<div class="form-group">
			...
			<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
				...
				@if($data['avata'] != '')
					<div class="form-group">
						<label> </label>
						<img src="{{ asset($data['avata']) }}" style="max-height: 100px">
					</div>
				@endif
			</div>
