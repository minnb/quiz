...
class Exam extends Model
{
    ...
    public static function insertTabkeQuiz($type, $course,$thematic, $lesson){
    	...
    	try{
			...
			Exam::insertDetailQuiz($heder_quiz_id, $course, $thematic, $info_exam[0]->lv1, 1);
			Exam::insertDetailQuiz($heder_quiz_id, $course, $thematic, $info_exam[0]->lv2, 2);
			Exam::insertDetailQuiz($heder_quiz_id, $course, $thematic, $info_exam[0]->lv3, 3);
			Exam::insertDetailQuiz($heder_quiz_id, $course, $thematic, $info_exam[0]->lv4, 4);
    ...
    public static function insertDetailQuiz($quiz_id, $course, $thematic, $level_question, $number){
